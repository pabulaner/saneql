...
src:=parser/ASTBase.cpp parser/SaneQLLexer.cpp infra/Schema.cpp semana/Functions.cpp semana/SemanticAnalysis.cpp algebra/Expression.cpp algebra/Operator.cpp sql/SQLWriter.cpp adapter/StringUtil.cpp adapter/ConditionUtil.cpp adapter/OperatorUtil.cpp adapter/TimeUtil.cpp adapter/Optimizer.cpp adapter/CppWriter.cpp adapter/CppCompiler.cpp main.cpp
