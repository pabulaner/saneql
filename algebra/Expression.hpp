...
class ComparisonExpression : public Expression {
   ...
   /// Get the IUs
   virtual std::vector<const IU*> getIUs() const { return util::combine<const IU*>(left->getIUs(), right->getIUs()); }
...
class BetweenExpression : public Expression {
   ...
   /// Get the IUs
   virtual std::vector<const IU*> getIUs() const { return util::combine<const IU*>(base->getIUs(), lower->getIUs(), upper->getIUs()); }
...
class SubstrExpression : public Expression {
   ...
   /// Get the IUs
   virtual std::vector<const IU*> getIUs() const { return util::combine<const IU*>(value->getIUs(), from->getIUs(), len->getIUs()); }
